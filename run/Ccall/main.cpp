...
int main () {	
	...
	int N =  map_monkeys_length_trial['r'];
	...
	sferes_call(fit, N, "../../data/data_txt/r", 0.792996,0.0431078,0.0698535,0.0759866,0.597401,0.715082,0.649917,0.64231,0.230317,0.852073);
